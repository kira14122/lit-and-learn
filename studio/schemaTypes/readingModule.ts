...
/**
 * Reading Module — one document = one module of the master reading course.
 *
 * A module is a numbered chapter (e.g. "Module 4: Paragraph Structure and
 * Transitions") holding an ORDERED list of references to Reading Bank
...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'array',
      of: [{type: 'reference', to: [{type: 'readingBank'}]}],
      description: 'Add Reading Bank lessons and drag to reorder. Students see them in this exact order.',
